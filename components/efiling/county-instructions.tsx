...
// Sourced from the canonical 102-county list. Earlier hand-maintained array
// was missing Ford and used the older "DeWitt" spelling — both fixed by the
// shared helper. See __tests__/lib/counties/all-counties.test.ts.
const ILLINOIS_COUNTIES = ALL_ILLINOIS_COUNTIES
