    ...
    <Card className="mb-6 border-dashed border-2 border-primary/30 bg-primary/5">
      <CardHeader>
        <CardTitle className="text-lg flex items-center gap-2">
          Getting started
          <ContextualHelp content="Complete these steps to get the most out of FreshStart IL. Start with the petition questionnaire, then add your case details and generate documents." />
        </CardTitle>
      </CardHeader>
      <CardContent>
