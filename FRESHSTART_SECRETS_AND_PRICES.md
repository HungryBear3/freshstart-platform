...
- [ ] **DIRECT_DATABASE_URL** = Supabase direct URL (port 5432) — required for `prisma migrate`; omit `.pooler` from host
- [ ] **SENTRY_DSN** = Sentry project DSN for error tracking (optional)
- [ ] **NEXT_PUBLIC_SENTRY_DSN** = Same DSN for client-side (optional; required for client error capture)
