...
describe("v2 header cross-page nav", () => {
  it("renders root-canonical pricing links and marks the active state on the pricing page", () => {
    // The v2 shell now serves as the canonical root experience; /v2 remains an alias.
  ...
  it("links the approved document/sunrise logo back to canonical root from both pages", () => {
    const home = ssr(<Header page="homepage" ctaLabel="Start my filing" />);
    const pricing = ssr(<Header page="pricing" ctaLabel="Start my filing" />);
