...
export interface CourtForm {
  ...
  requiredFor: ("with_children" | "no_children" | "both")[]; instructions?: string
  /** Questionnaire response objects read by an evidence-bound field map for this row. */
...
export const ILLINOIS_COURT_FORMS:CourtForm[]=[
 ...
 unsupported({id:"marital-settlement-agreement",name:"Marital Settlement Agreement",description:"FreshStart template, not an Illinois standardized form.",category:"judgment",filename:"marital-settlement-agreement.pdf",authority:"freshstart_template",requiredFor:["both"],relatedQuestionnaires:[]}),
