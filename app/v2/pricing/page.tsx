...
export const metadata: Metadata = {
  ...
  description:
    "Essential ($149 one-time) and Plus ($299/yr) FreshStart IL plans for Illinois divorce filings. 7-day free trial, 30-day refund policy, available in all 102 Illinois counties.",
